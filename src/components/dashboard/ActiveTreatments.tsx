  ...
  return (
    <div className="glass-card p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-sm font-semibold text-[var(--color-adaline-ink)]/85">Traitements en Cours</h3>
      ...
      {activeTreatments.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-8 text-center">
          <Droplets className="w-8 h-8 text-[var(--color-adaline-ink)]/35 mb-3" />
          <p className="text-sm text-[var(--color-adaline-ink)]/55">Aucun traitement actif</p>
          <p className="text-xs text-[var(--color-adaline-ink)]/40 mt-1">
            ...
            <div
              ...
              className={cn(
                ...
                treatment.status === "in_progress"
                  ? "bg-[var(--color-valley-green)]/10 border-[var(--color-valley-green)]/20"
                  : "bg-[var(--color-valley-green)]/10 border-[var(--color-valley-green)]/20"
              )}
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center gap-2">
                  <Clock className="w-3.5 h-3.5 text-[var(--color-adaline-ink)]/40" />
